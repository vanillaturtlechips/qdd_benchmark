...
::: {.long}
{{include:tables/t5_specs_arm.md}}
:::
...
{{include:tables/t3_bench_wrist.md}}

**팔꿈치 클래스** (joint3 리그, 롤 축, kp 70 / kd 2.0)

{{include:tables/t3_bench_elbow.md}}

**어깨 클래스** (joint1 리그, kp 70 / kd 2.75)

{{include:tables/t3_bench_shoulder.md}}
...
{{include:tables/t4_sens_wrist.md}}

**팔꿈치**

{{include:tables/t4_sens_elbow.md}}

**어깨**

{{include:tables/t4_sens_shoulder.md}}
...
{{include:../../isaac/comparison_specs.md|strip-title}}

# 부록 B. 벤치 전체 지표

{{include:../../isaac/bench_metrics.md|strip-title|shift=1}}
:::
